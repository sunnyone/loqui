...
#define GTK_TOOL_ITEM_GET_PRIVATE(o)  (GTK_TOOL_ITEM(o)->priv)
 ...
 * <itemizedlist>
 * <listitem>gtk24_toolbar_get_orientation()</listitem>
 * <listitem>gtk24_toolbar_get_style()</listitem>
 * <listitem>gtk24_toolbar_get_icon_size()</listitem>
 * <listitem>gtk24_toolbar_get_relief_style()</listitem>
 * </itemizedlist>
 ...
 **/
  toolitem_signals[SET_TOOLTIP] =
    g_signal_new ("set_tooltip",
		  ...
		  _gtk_boolean_handled_accumulator, NULL,
		  _gtk24_marshal_BOOLEAN__OBJECT_STRING_STRING,
		  G_TYPE_BOOLEAN, 3,
		  GTK_TYPE_TOOLTIPS,
		  G_TYPE_STRING,
		  G_TYPE_STRING);		  
...
gtk_tool_item_get_icon_size (GtkToolItem *tool_item)
{
  ...
  if (!parent || !GTK24_IS_TOOLBAR (parent))
    return GTK_ICON_SIZE_LARGE_TOOLBAR;

  return gtk24_toolbar_get_icon_size (GTK24_TOOLBAR (parent));
}
...
gtk_tool_item_get_orientation (GtkToolItem *tool_item)
{
  ...
  return gtk24_toolbar_get_orientation (GTK24_TOOLBAR (parent));
}
...
gtk_tool_item_get_toolbar_style (GtkToolItem *tool_item)
{
  ...
  return gtk24_toolbar_get_style (GTK24_TOOLBAR (parent));
}
...
gtk_tool_item_get_relief_style (GtkToolItem *tool_item)
{
  ...
  return gtk24_toolbar_get_relief_style (GTK24_TOOLBAR (parent));
}
