...
#define GTK_TOGGLE_TOOL_BUTTON_GET_PRIVATE(obj) (GTK_TOGGLE_TOOL_BUTTON(obj)->priv)
...
static void
gtk_toggle_tool_button_finalize (GObject *object)
{
  GtkToggleToolButton *self;

  self = GTK_TOGGLE_TOOL_BUTTON(object);
  g_free(self->priv);
