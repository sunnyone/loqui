...
{
  action->private_data = g_new0(GtkActionPrivate, 1);
			 ...
			 GtkWidget  *proxy)
{
  ...
  if (GTK24_IS_TOOLBAR (gtk_widget_get_parent (proxy)))
    {
      Gtk24Toolbar *toolbar = GTK24_TOOLBAR (gtk_widget_get_parent (proxy));
