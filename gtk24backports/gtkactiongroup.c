...
#define GTK_ACTION_GROUP_GET_PRIVATE(obj) (GTK_ACTION_GROUP(obj)->private_data)
...
{
  self->private_data = g_new0(GtkActionGroupPrivate, 1);
...
{
  return (gchar*) dgettext (domainname, msgid);
}
