...
static GtkItemFactoryEntry menu_items[] = {
	...
	{ N_("/View/Previous fresh channel"), "<Alt>P", loqui_menu_view_move_cb, 0, "<StockItem>", GTK_STOCK_GO_UP},
	{ N_("/View/Next fresh channel"), "<Alt>N", loqui_menu_view_move_cb, 1, "<StockItem>", GTK_STOCK_GO_DOWN},
