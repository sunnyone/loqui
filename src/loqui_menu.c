...
static GtkItemFactoryEntry menu_items[] = {
	...
	{ N_("/View/Previous updated channel"), "<Alt>P", loqui_menu_view_move_cb, 0, "<StockItem>", GTK_STOCK_GOTO_TOP},
	{ N_("/View/Next updated channel"), "<Alt>N", loqui_menu_view_move_cb, 1, "<StockItem>", GTK_STOCK_GOTO_BOTTOM},
