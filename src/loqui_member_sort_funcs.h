...
gint loqui_member_sort_funcs_power_nick(LoquiMember **ma_p, LoquiMember **mb_p);
gint loqui_member_sort_funcs_away_nick(LoquiMember **ma_p, LoquiMember **mb_p);

gint loqui_member_sort_funcs_power_away_nick(LoquiMember **ma_p, LoquiMember **mb_p);
...
gint loqui_member_sort_funcs_time_power_away_nick(LoquiMember **ma_p, LoquiMember **mb_p);
