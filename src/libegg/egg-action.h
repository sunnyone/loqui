...
const gchar *egg_action_get_name            (EggAction *action);
...
void         egg_action_set_sensitive         (EggAction *action,
					       gboolean sensitive);
void         egg_action_set_visible           (EggAction *action,
					       gboolean visible);
...
void       egg_action_unblock_activate_from (EggAction *action,
					     GtkWidget *proxy);
void       egg_action_sync_property         (EggAction  *action,
					     GParamSpec *pspec,
					     GtkWidget  *proxy);
void       egg_action_remove_proxy          (GtkWidget  *widget,
					     EggAction  *action);

/* protected ... for use by action groups */
void       egg_action_set_accelerator       (EggAction *action,
