...
void loqui_channel_entry_ui_add_channel(LoquiApp *app, Channel *channel, const gchar *path, const gchar *data_prefix);
void loqui_channel_entry_ui_remove_channel(LoquiApp *app, Channel *channel, const gchar *data_prefix);
